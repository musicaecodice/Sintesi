...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 31.0, 150.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.666662752628326, 31.0, 161.0, 129.0 ],
					"text" : ";\rinstr_9 0 freq 500;\rinstr_9 0 wave pulse;\rinstr_9 0 env 1 10 1 80 0 10;\rinstr_9 0 duty 127 50 0 50;\rinstr_9 0 dur 2500;\rinstr_9 0 amp 1;\rinstr_9 0 pan 0;\rinstr_9 1 t_gate bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 84.666663229465485, 118.63105845451355, 107.0, 22.0 ],
					"text" : "myPwm instr_9 64"
				}
